...
import com.imhos.security.handlers.GWTAuthenticationSuccessHandler;
 ...
 */
public class MyRememberMeFilter extends GenericFilterBean implements ApplicationEventPublisherAware {

    //~ Instance fields ================================================================================================

    private ApplicationEventPublisher eventPublisher;
    private GWTAuthenticationSuccessHandler successHandler;
...
//
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        if (SecurityContextHolder.getContext().getAuthentication() == null) {
         ...
         //     if (!facebookController.checkAccount(rememberMeAuth)) {
...
//                    }
     ...
     */
    @Deprecated
    public void setRememberMeServices(MyRememberMeServices rememberMeServices) {
        this.rememberMeServices = rememberMeServices;
    }
     ...
     */
    public void setAuthenticationSuccessHandler(GWTAuthenticationSuccessHandler successHandler) {
