...
public abstract class MyRememberMeServices implements RememberMeServices, InitializingBean, LogoutHandler {
     ...
     */
    @Deprecated
    protected MyRememberMeServices() {
        this.setHttpOnlyMethod = ReflectionUtils.findMethod(Cookie.class, "setHttpOnly", boolean.class);
    }

    protected MyRememberMeServices(String key, UserDetailsService userDetailsService) {
    ...
    //overriding AbstractRememberMeServices method (TokenBasedRememberMeServices do the same)
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        //___!!!___Here we should paste the checking of facebook user (does he still exist?)___!!!___
    ...
    // TokenBasedRememberMeServices method
     ...
     *
     * @param userDetailsChecker the strategy which will be passed the user object to allow it to be rejected if account should not
